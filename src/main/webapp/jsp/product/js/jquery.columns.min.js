 ...
 * 
 * Author: Michael Eisenbraun Version: 2.2.0 Requires: jQuery 1.7.2+
...
(function(e) {
	...
	var t = function(t, n) {
		...
		this.sort = function() {
			...
			e.sortBy && typeof e.data[0][e.sortBy] != "undefined"
		...
		this.create = function() {
			...
			function r(n, r) {
				var i = [];
				n % 2 === 0 ? i.push('<tr class="' + t.evenRowClass + '">') : i
						.push('<tr class="' + t.oddRowClass + '">');
